...
migrate-down:
	DB_REV=08 make migrate-down-single
	DB_REV=07 make migrate-down-single
	DB_REV=06 make migrate-down-single
...
migrate-up:
	...
	DB_REV=06 make migrate-up-single
	DB_REV=07 make migrate-up-single
	DB_REV=08 make migrate-up-single
